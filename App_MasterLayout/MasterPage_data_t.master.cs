...
public partial class App_MasterLayout_MasterPage_data_t : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if ( !Sercurity.CheckPermission2(Session["r_id"].ToString(), Session["Category"].ToString())) {
                //沒有權限, 跳轉main.aspx
    ...
    private void GetLeftTree()
    {
        ...
        Li1.Text = "";
        Li1.Text += "<ul id=\"shortcuts\" role=\"complementary\" style=\"height:120%\"  class=\"children-tooltip tooltip-right\">";
