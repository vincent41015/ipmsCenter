...
{
    static string Web_ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["TSMCdbConnectionString"].ConnectionString;
    ...
    public bool isExistCard(string CardNo)
    {
        bool result = false;
        ...
        try
        {
            using (SqlConnection conn = new SqlConnection())
            {
                conn.ConnectionString = Web_ConnectionString;
                conn.Open();
                string sql = "SELECT count(*) FRom Vendor WHERE CardNo = @CardNo";
    ...
    public bool isExistBlueCard(string CardNo)
    {
        bool result = false;
        ...
        try
        {
            using (SqlConnection conn = new SqlConnection())
            {
                conn.ConnectionString = Web_ConnectionString;
                conn.Open();
                string sql = "SELECT count(*) FRom Vendor WHERE BlueCard = @CardNo";
                using (SqlCommand cmd = new SqlCommand(sql, conn))
                {
                    cmd.Parameters.Add(new SqlParameter("CardNo", CardNo));
                    int r = (int)cmd.ExecuteScalar();
    ...
    public bool isExistEmployee(string _id)
    {
        bool result = false;
        ...
        try
        {
            using (SqlConnection conn = new SqlConnection())
            {
                conn.ConnectionString = Web_ConnectionString;
                conn.Open();
                string sql = "SELECT count(*) FRom PeopleManage WHERE [id] = @_id";
                using (SqlCommand cmd = new SqlCommand(sql, conn))
                {
